namespace JenkinsNotification.CustomControls.Converters
{
    ...
    /// <summary>
    /// <see cref="JobResultType"/> から前景色<see cref="Brush"/> へのコンバーター クラスです。
    /// </summary>
    /// <seealso cref="System.Windows.Data.IValueConverter" />
    [ValueConversion(typeof(JobResultType), typeof(Brush))]
    public class JobResultTypeToForegroundConverter : IValueConverter
    {
        #region Fields

        /// <summary>
        /// <see cref="JobResultType"/> に対する前景色のマップ情報
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public JobResultTypeToForegroundConverter()
        {
            var app          = Application.Current;
            var successBrush = app.TryFindResource("BalloonTip.JobSuccess.Foreground") as Brush;
            var warningBrush = app.TryFindResource("BalloonTip.JobWarning.Foreground") as Brush;
            var failedBrush  = app.TryFindResource("BalloonTip.JobFailed.Foreground") as Brush;
