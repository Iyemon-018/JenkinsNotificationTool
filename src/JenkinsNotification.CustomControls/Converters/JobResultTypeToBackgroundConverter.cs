namespace JenkinsNotification.CustomControls.Converters
{
    ...
    /// <summary>
    /// <see cref="JobResultType"/> から背景色<see cref="Brush"/> へのコンバーター クラスです。
    /// </summary>
    /// <seealso cref="System.Windows.Data.IValueConverter" />
    [ValueConversion(typeof(JobResultType), typeof(Brush))]
    public class JobResultTypeToBackgroundConverter : IValueConverter
    {
        #region Fields

        /// <summary>
        /// <see cref="JobResultType"/> に対する背景色のマップ情報
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public JobResultTypeToBackgroundConverter()
        {
            var app          = Application.Current;
            var successBrush = app.TryFindResource("BalloonTip.JobSuccess.Background") as Brush;
            var warningBrush = app.TryFindResource("BalloonTip.JobWarning.Background") as Brush;
            var failedBrush  = app.TryFindResource("BalloonTip.JobFailed.Background") as Brush;
